package com.example.administrator.maimengcartoon.utils;
...
public class TabFragmentUtils implements RadioGroup.OnCheckedChangeListener {
    ...
    public TabFragmentUtils(RadioGroup radioGroup, List<Fragment> fragments, int containerLayout, FragmentManager fragmentManager) {
    ...
    public void onCheckedChanged(RadioGroup group, int checkedId) {
        for (int i = 0; i < group.getChildCount(); i++) {
            ...
            if(view.getId() == checkedId)
            {
                ...
                view.setTextColor(Color.parseColor("#DD2248"));
            }else{
